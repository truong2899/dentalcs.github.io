								...
								<div class="col-lg-12">
									<form id="login-form" action="" method="post"  style="display: block;">
										...
										<div class="che-box">
											...
											<a href = "../login_form/signup_user.php"><i class="fas fa-user-plus"></i>Tạo tài khoản mới</a>
											</label>
										</div>
										<ul>
											<li>
										...
										<div class="form-group">
											<div class="row">
												...
												<?php $previous = $_SERVER['HTTP_REFERER']; echo "<input type='hidden'  name ='http' value='$previous' />";?>	
												</div>
											</div>
										</div>
										<div class="form-group">
